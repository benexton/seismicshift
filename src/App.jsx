  ...
  const qdModel = (
    <div style={{ position: 'relative' }}>
      <div ref={qdContainerRef} className="h-72 md:h-80 lg:h-[480px] w-full"
        ...
        {...trackMouse(qdMouse)}>
        <Canvas shadows camera={{ position: [2, 0.5, 6], fov: 38 }} gl={{ toneMapping: 4, toneMappingExposure: 1.2, powerPreference: "high-performance" }}>
  ...
  const ffModel = (
    <div style={{ position: 'relative' }}>
      <div ref={ffContainerRef} className="h-72 md:h-80 lg:h-[480px] w-full"
        ...
        {...trackMouse(ffMouse)}>
        <Canvas shadows camera={{ position: [0, 1, 6], fov: 38 }} gl={{ toneMapping: 4, toneMappingExposure: 1.2, powerPreference: "high-performance" }}>
          <Suspense fallback={null}>
