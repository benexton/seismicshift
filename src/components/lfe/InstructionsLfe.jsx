    ...
    <div className="panel-scroll">
      <div className="panel-inner instructions left-aligned">
        ...
        <p><b>Reviewing a record:</b> in the panel you can correct the
          classification, observation type(s), mechanism, and coordinates. An
          observation can be ticked as more than one type at once - for example
          a building that also shows liquefaction, or a good example of
          emergency management / response rather than structural damage.
          Scraped items often have only an approximate, geocoded location, so
          fixing the latitude and longitude to the true spot is one of the
          most valuable things you can do. This is also where the human adds
          value the AI cannot: adding a Street View screenshot, extra source
          links, and notes, and confirming the building attributes before it
          is verified.
        </p>
        ...
        <p>
          ...
          the name, type, primary material, and height class. You can attach
          a photo and a Street View screenshot, set your confidence in the
          location, and add as many links as you like. Submitting sends it to
          the queue for a second person to verify, so entries are always
        ...
        <p className="muted" style={{ marginTop: 24 }}>
          If you administer this event - creating events, mobilising
          volunteers, or setting up the automated pipeline - see the separate
          Admin page (linked from your events list) rather than these tabs.
        </p>
        <p className="muted">
